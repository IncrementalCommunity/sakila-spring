package web.sakila.webapi.model;
...
public class StoreWO extends WebObject {
	...
	public String toString() {
		return "StoreWO [storeId=" + storeId + ", adress=" + adress + ", customers=" + customers + ", inventories="
				+ inventories + ", managerStaff=" + managerStaff + ", staffs=" + staffs + "]";
	}
